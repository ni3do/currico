  ...
  if (!multiPageMaterial) {
    multiPageMaterial = await prisma.resource.create({
      data: {
        ...
        preview_url: "https://placehold.co/800x1131/e5e5e5/666666.png?text=Page+1",
        preview_urls: [
          "https://placehold.co/800x1131/e5e5e5/666666.png?text=Page+1",
          "https://placehold.co/800x1131/e5e5e5/666666.png?text=Page+2",
          "https://placehold.co/800x1131/e5e5e5/666666.png?text=Page+3",
        ],
        preview_count: 3,
        subjects: ["MA"],
        cycles: ["2"],
  ...
  if (!singlePageMaterial) {
    singlePageMaterial = await prisma.resource.create({
      data: {
        ...
        preview_url: "https://placehold.co/800x1131/d4edda/155724.png?text=Single+Page+Document",
        preview_urls: ["https://placehold.co/800x1131/d4edda/155724.png?text=Single+Page+Document"],
        preview_count: 1,
        subjects: ["DE"],
        cycles: ["2"],
        is_published: true,
  ...
  if (!bundleMaterial1) {
    bundleMaterial1 = await prisma.resource.create({
      data: {
        ...
        preview_url: "https://placehold.co/800x1131/cce5ff/004085.png?text=Pflanzen",
        preview_urls: [
          "https://placehold.co/800x1131/cce5ff/004085.png?text=Pflanzen",
          "https://placehold.co/800x1131/cce5ff/004085.png?text=Pflanzen+2",
        ],
        preview_count: 2,
        subjects: ["NMG"],
        cycles: ["2"],
  ...
  if (!bundleMaterial2) {
    bundleMaterial2 = await prisma.resource.create({
      data: {
        ...
        preview_url: "https://placehold.co/800x1131/fff3cd/856404.png?text=Tiere",
        preview_urls: [
          "https://placehold.co/800x1131/fff3cd/856404.png?text=Tiere",
          "https://placehold.co/800x1131/fff3cd/856404.png?text=Tiere+2",
        ],
        preview_count: 2,
        subjects: ["NMG"],
        cycles: ["2"],
  ...
  if (!bundleMaterial3) {
    bundleMaterial3 = await prisma.resource.create({
      data: {
        ...
        preview_url: "https://placehold.co/800x1131/d1ecf1/0c5460.png?text=Wasser",
        preview_urls: ["https://placehold.co/800x1131/d1ecf1/0c5460.png?text=Wasser"],
        preview_count: 1,
        subjects: ["NMG"],
        cycles: ["2"],
        is_published: true,
  ...
  if (!bundle) {
    bundle = await prisma.bundle.create({
      data: {
        ...
        subjects: ["NMG"],
        cycles: ["2"],
        cover_image_url: "https://placehold.co/800x600/e2e3e5/383d41.png?text=Naturkunde+Bundle",
        is_published: true,
        status: "VERIFIED",
        seller_id: user.id,
      },
