            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 py-16 lg:py-24 items-center">
              ...
              <div className="order-2 lg:order-1">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[var(--color-primary-light)] rounded-md mb-6">
                  <span className="text-[var(--color-primary)] text-sm font-medium">{homePage.hero.badge}</span>
                </div>
                ...
                <div className="mt-10 pt-8 border-t border-[var(--color-border)]">
                  <p className="text-sm text-[var(--color-text-muted)] mb-3">{homePage.hero.trustLabel}</p>
        ...
        <section className="bg-[var(--color-bg)] py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-8">
              <div>
                <h2 className="text-2xl font-semibold text-[var(--color-text)]">{homePage.featuredResources.title}</h2>
                <p className="mt-2 text-[var(--color-text-muted)]">{homePage.featuredResources.description}</p>
              </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <article className="card group overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-[var(--color-border-subtle)] flex items-center justify-between">
                    <span className="text-sm text-[var(--color-text-muted)]">{homePage.featuredResources.card1.documents}</span>
              ...
              <article className="card group overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-[var(--color-border-subtle)] flex items-center justify-between">
                    <span className="text-sm text-[var(--color-text-muted)]">{homePage.featuredResources.card2.documents}</span>
                    <div className="flex items-center gap-1 text-sm font-medium text-[var(--color-text-secondary)]">
                      <svg className="w-4 h-4 text-[var(--color-warning)]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
              ...
              <article className="card group overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-[var(--color-border-subtle)] flex items-center justify-between">
                    <span className="text-sm text-[var(--color-text-muted)]">{homePage.featuredResources.card3.documents}</span>
                    <div className="flex items-center gap-1 text-sm font-medium text-[var(--color-text-secondary)]">
                      <svg className="w-4 h-4 text-[var(--color-warning)]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 sm:grid-cols-3">
              <div className="text-center">
                <div className="text-4xl font-bold text-[var(--color-primary)]">{homePage.stats.materials.value}</div>
                <div className="mt-2 text-sm text-[var(--color-text-muted)] font-medium">{homePage.stats.materials.label}</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[var(--color-accent)]">{homePage.stats.teachers.value}</div>
                <div className="mt-2 text-sm text-[var(--color-text-muted)] font-medium">{homePage.stats.teachers.label}</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[var(--color-primary)]">{homePage.stats.satisfaction.value}</div>
                <div className="mt-2 text-sm text-[var(--color-text-muted)] font-medium">{homePage.stats.satisfaction.label}</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-lg font-semibold text-[var(--color-text)]">{common.brand.name}</span>
              </div>
            ...
            {/* Product */}
            <div>
              <h3 className="font-semibold text-[var(--color-text)] text-sm uppercase tracking-wider">{common.footer.platformSection.title}</h3>
              <ul className="mt-4 space-y-3">
                <li><Link href="/resources" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.platformSection.resources}</Link></li>
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.platformSection.pricing}</Link></li>
              </ul>
            </div>

            {/* Company */}
            <div>
              <h3 className="font-semibold text-[var(--color-text)] text-sm uppercase tracking-wider">{common.footer.infoSection.title}</h3>
              <ul className="mt-4 space-y-3">
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.infoSection.aboutUs}</Link></li>
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.infoSection.contact}</Link></li>
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.infoSection.help}</Link></li>
              </ul>
            </div>

            {/* Legal */}
            <div>
              <h3 className="font-semibold text-[var(--color-text)] text-sm uppercase tracking-wider">{common.footer.legalSection.title}</h3>
              <ul className="mt-4 space-y-3">
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.legalSection.privacy}</Link></li>
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.legalSection.terms}</Link></li>
                <li><Link href="/coming-soon" className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors">{common.footer.legalSection.imprint}</Link></li>
              </ul>
            </div>
          </div>
