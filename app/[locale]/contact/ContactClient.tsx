      ...
      <main className="flex-1">
        ...
        <section>
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="text-text-muted mt-6 text-xl leading-relaxed">{t("hero.subtitle")}</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-20">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="text-text mb-4 text-xl font-semibold sm:text-2xl">{t("faq.title")}</h2>
            <p className="text-text-muted mb-8">{t("faq.description")}</p>
          </div>
        </section>
      </main>
