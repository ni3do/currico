...
import { FadeIn, StaggerChildren, StaggerItem, ScaleIn, motion } from "@/components/ui/animations";
import {
  BadgeCheck,
  BookOpen,
  Zap,
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <StaggerChildren staggerDelay={0.15} className="grid gap-8 md:grid-cols-3">
              ...
              <StaggerItem className="relative">
                ...
                >
                  <motion.div
                    className="bg-primary-light mb-5 flex h-16 w-16 items-center justify-center rounded-2xl"
              ...
              <StaggerItem className="relative">
                ...
                >
                  <motion.div
                    className="bg-accent-light mb-5 flex h-16 w-16 items-center justify-center rounded-2xl"
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    transition={{ duration: 0.2 }}
                  >
                    <svg
              ...
              <StaggerItem className="relative">
                ...
                >
                  <motion.div
                    className="bg-success-light mb-5 flex h-16 w-16 items-center justify-center rounded-2xl"
                    whileHover={{ scale: 1.1, rotate: 5 }}
                    transition={{ duration: 0.2 }}
                  >
                    <svg
        ...
        <section id="features" className="py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <FadeIn direction="up" className="mx-auto mb-16 max-w-2xl text-center">
            ...
            >
              ...
              <StaggerItem>
                ...
                >
                  <motion.div
                    className="bg-primary-light mb-6 flex h-12 w-12 items-center justify-center rounded-xl"
              ...
              <StaggerItem>
                ...
                >
                  <motion.div
                    className="bg-accent-light mb-6 flex h-12 w-12 items-center justify-center rounded-xl"
                    whileHover={{ rotate: 10, scale: 1.1 }}
                    transition={{ duration: 0.2 }}
                  >
              ...
              <StaggerItem>
                ...
                >
                  <motion.div
                    className="bg-success-light mb-6 flex h-12 w-12 items-center justify-center rounded-xl"
                    whileHover={{ rotate: 10, scale: 1.1 }}
                    transition={{ duration: 0.2 }}
                  >
                ...
                <div className="relative grid gap-8 lg:grid-cols-2 lg:gap-12">
                  ...
                  >
                    <StaggerItem>
                      ...
                      >
                        <motion.div
                          className="bg-primary-light flex h-10 w-10 shrink-0 items-center justify-center rounded-lg"
                          whileHover={{ scale: 1.1, rotate: 5 }}
                        >
                    ...
                    <StaggerItem>
                      ...
                      >
                        <motion.div
                          className="bg-accent-light flex h-10 w-10 shrink-0 items-center justify-center rounded-lg"
                          whileHover={{ scale: 1.1, rotate: 5 }}
                        >
                    ...
                    <StaggerItem>
                      ...
                      >
                        <motion.div
                          className="bg-success-light flex h-10 w-10 shrink-0 items-center justify-center rounded-lg"
                          whileHover={{ scale: 1.1, rotate: 5 }}
                        >
