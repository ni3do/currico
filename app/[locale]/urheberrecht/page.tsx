    ...
    <div className="bg-bg flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          {/* Table of Contents */}
          <nav
            className="no-print bg-surface border-border rounded-xl border p-6"
          ...
          <section
            id="legalBasis"
            className="bg-surface border-border scroll-mt-4 rounded-xl border p-6"
          >
            <div className="mb-4 flex items-center gap-3">
              <div className="bg-primary/10 flex h-10 w-10 items-center justify-center rounded-lg">
                <Scale className="text-primary h-5 w-5" />
              </div>
              <h2 className="text-text text-xl font-semibold">{t("sections.legalBasis.title")}</h2>
            </div>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-text text-xl font-semibold">{t("sections.notAllowed.title")}</h2>
            </div>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-text text-xl font-semibold">{t("sections.ccLicenses.title")}</h2>
            </div>
            ...
            <div className="bg-primary/5 border-primary/20 mt-4 rounded-lg border p-3">
              <div className="flex items-start gap-2">
                ...
                <span className="text-text-secondary text-sm">{t("sections.ccLicenses.tip")}</span>
              </div>
            </div>
          </section>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-text text-xl font-semibold">{t("sections.aiContent.title")}</h2>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="border-success/20 bg-success/5 rounded-lg border p-4">
                <div className="mb-3 flex items-center gap-2">
                  ...
                  <h3 className="text-success font-medium">{t("sections.images.allowedTitle")}</h3>
                </div>
                <ul className="space-y-2">
                  {(["ownPhotos", "cc0Images", "purchasedStock", "createdGraphics"] as const).map(
                    (key) => (
                      <li key={key} className="flex items-start gap-2">
                        <CheckCircle className="text-success mt-0.5 h-3.5 w-3.5 flex-shrink-0" />
                        <span className="text-text-secondary text-sm">
              ...
              <div className="border-error/20 bg-error/5 rounded-lg border p-4">
                <div className="mb-3 flex items-center gap-2">
                  ...
                  <h3 className="text-error font-medium">{t("sections.images.notAllowedTitle")}</h3>
                </div>
                <ul className="space-y-2">
                  {(
          ...
          >
            ...
            <ul className="space-y-3">
              {(["unsplash", "pixabay", "pexels", "openclipart", "wikimediaCommons"] as const).map(
                (key) => (
                  <li key={key} className="flex items-start gap-3">
                    <CheckCircle className="text-success mt-0.5 h-4 w-4 flex-shrink-0" />
                    <span className="text-text-secondary text-sm">
          ...
          >
            ...
            <ul className="space-y-2">
              {(["googleFonts", "purchasedFonts", "systemFonts", "freeWithLicense"] as const).map(
                (key) => (
                  <li key={key} className="flex items-start gap-3">
                    <CheckCircle className="text-success mt-0.5 h-4 w-4 flex-shrink-0" />
                    <span className="text-text-secondary text-sm">
            ...
            <div className="bg-warning/10 border-warning/20 mt-4 rounded-lg border p-3">
              <div className="flex items-start gap-2">
                ...
                <span className="text-text-secondary text-sm">{t("sections.fonts.warning")}</span>
              </div>
            </div>
          </section>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-text text-xl font-semibold">{t("sections.greyAreas.title")}</h2>
            </div>
          ...
          >
            ...
            <p className="text-text-secondary mb-4">{t("sections.commonMistakes.description")}</p>
            <div className="space-y-4">
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-text text-xl font-semibold">{t("sections.checklist.title")}</h2>
              <span
          ...
          <section
            id="contact"
            className="border-border bg-bg-secondary scroll-mt-4 rounded-xl border p-6 text-center"
          >
