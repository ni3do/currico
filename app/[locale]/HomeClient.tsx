...
const SectionSkeleton = () => (
  <div className="py-24" role="status" aria-busy="true">
    <div className="mx-auto max-w-7xl px-4 min-[1920px]:max-w-[1800px] 2xl:max-w-[1440px]">
    ...
    <div className="bg-bg flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="relative mx-auto w-full max-w-7xl px-6 pt-6 pb-12 min-[1920px]:max-w-[1800px] sm:px-8 sm:pt-8 sm:pb-16 lg:px-12 lg:pt-10 lg:pb-20 2xl:max-w-[1440px]">
        ...
        <section aria-labelledby="featured-heading" className="bg-surface py-24">
          <div className="mx-auto max-w-7xl px-4 min-[1920px]:max-w-[1800px] sm:px-6 lg:px-8 2xl:max-w-[1440px]">
            ...
            {featuredMaterials.length > 0 ? (
              <StaggerChildren
                staggerDelay={0.1}
                className="grid gap-6 min-[1920px]:grid-cols-5 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4"
              >
