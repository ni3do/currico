...
export default function MaterialienPage() {
  ...
  return (
    <div className="bg-bg flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 min-[1920px]:max-w-[1800px] sm:px-6 sm:py-10 lg:px-8 lg:py-12 2xl:max-w-[1440px]">
        {/* Page Header */}
                ...
                <motion.div
                  ...
                  className={
                    viewMode === "grid" || !filters.showMaterials
                      ? "grid gap-5 min-[1920px]:grid-cols-5 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3 2xl:grid-cols-4"
                      : "flex flex-col gap-5"
                  }
