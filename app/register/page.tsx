    ...
    <div className="min-h-screen bg-[--background]">
      ...
      <header className="border-b border-[--border] bg-[--surface]/95">
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            >
              Bereits registriert? <span className="font-medium">Anmelden</span>
            </a>
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-2xl px-4 py-16">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-[--text]">Konto erstellen</h1>
          <p className="mt-2 text-[--text-muted]">
            Werden Sie Teil der Easy Lehrer Community
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-[--border] bg-[--surface] p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                {accountType === "teacher" ? "Vollständiger Name" : "Schulname"}
              </label>
              <input
                type="text"
                id="name"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                    {[
                      ...
                      <label
                        key={subject}
                        className="flex items-center gap-2 rounded-lg border border-[--border] bg-[--background] px-3 py-2 cursor-pointer hover:border-[--primary] transition-colors"
                      >
                        <input
                          type="checkbox"
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {["Zyklus 1", "Zyklus 2", "Zyklus 3"].map((cycle) => (
                      ...
                      >
                        ...
                        />
                        <span className="text-sm text-[--text]">{cycle}</span>
                      </label>
                    ))}
                  </div>
                </div>
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-gradient-to-r from-[--primary] to-[--secondary] px-6 py-4 font-semibold text-[--background] hover:opacity-90 transition-opacity shadow-lg shadow-[--primary]/20"
            >
              Konto erstellen
            </button>
          </form>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid gap-3">
            <button className="flex items-center justify-center gap-3 rounded-xl border border-[--border] bg-[--surface] px-4 py-3 text-[--text] hover:bg-[--surface1] transition-colors">
