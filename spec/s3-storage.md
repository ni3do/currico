...
Add provider-agnostic S3-compatible object storage to Currico, replacing local filesystem storage. Optimized for Infomaniak Object Storage with Swiss data residency.
...
2. Create two buckets: `currico-public`, `currico-private`
